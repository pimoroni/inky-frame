...
FILENAME = "/sd/placebear.jpg"
ENDPOINT = "https://placebear.com/{0}/{1}.jpg"
# Note that the API needs to be serving up non-progressive .jpg files to work with jpegdec
...
url = ENDPOINT.format(WIDTH, HEIGHT)
print(url)
